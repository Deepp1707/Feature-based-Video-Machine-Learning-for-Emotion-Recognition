...
def get_blink_ratio(eye_points, facial_landmarks):
    ...
    corner_left = (facial_landmarks.part(eye_points[8]).x,
                   facial_landmarks.part(eye_points[8]).y)
    corner_right = (facial_landmarks.part(eye_points[5]).x,
...
left_eyebrow_landmark= [17,18, 19, 20, 21]
left_eye_landmarks = [17,18,19,20,21, 39, 40, 41,36,37, 38]

right_eyebrow_landmark = [22, 23, 24, 25, 26]
...
while True:
    ...
    for face in faces:
        ...
        if left_eye_ratio and right_eye_ratio >=  BLINK_RATIO_THRESHOLD:
            count += 1
